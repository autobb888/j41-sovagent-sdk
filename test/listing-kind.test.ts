...
describe('parseListingKind', () => {
  ...
  it('rejects missing, model, and lookalikes', () => {
...
describe('advertisedIdentity', () => {
  it('qualifies a leaf under the kind parent, not agentplatform@', () => {
...
describe('LISTING_KINDS', () => {
  it('does not include model — sovmodel is catalog-only until the backend lists it', () => {
